...
const backpackList = backpackObjectArray.map((backpack) => {
  ...
  const new_lid = backpackArticle.querySelector(".backpack__lid")


  button.addEventListener("click", (event) => {
    console.log(event);
    new_lid.innerText === "Lid Status: open" ? new_lid.innerText = "Lid Status: closed" : new_lid.innerText = "Lid Status: open"
  });
