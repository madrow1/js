...
const formatter = (locale, currency, value) => {
  let formattedValue
  formattedValue = new Intl.NumberFormat(locale, { style: 'currency', currency: currency }).format(value);
  return formattedValue
}

const tipCalculator = (locale, currency, sum, percentage) => {
...
tipCalculator("de-DE", "EUR", 29.95, 18);
