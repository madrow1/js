...
const tipCalculator = (sum, percentage, locale, currency, callback) => { // added the callback value to tipcalc
  ...
  callback(finalTip) // added a callback to the end of the function executino
};

tipCalculator(29.95, 18, "de-DE", "EUR", printHTML); // passed in the printHTML function to the callback value in the tipCalculator function, so that it is called when the tip is fully calculated
